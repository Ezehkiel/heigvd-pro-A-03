...
/**
 * This class regroups all the methods for users logic. This is our
 * controller
 */
public class UserController {
    ...
    public User getUser(Request req) {
        ...
        return SqlRequest.getUserDBWithUsername(username);
    }
     ...
     *
     * @param req this is the request that we received from the client
     * @return a JSONObject with a JWT token and the user as data field
     */
    ...
    /**
     * This method is used by the server. When a game is finished the server
    ...
    public JSONObject getUserScore(Request req) {
        ...
        try {
            ...
            /*
            * We verified that the token is correct, only a authenticated user
            * can get a user score
            */
            Algorithm algorithm = Algorithm.HMAC256("pro2019heig");
